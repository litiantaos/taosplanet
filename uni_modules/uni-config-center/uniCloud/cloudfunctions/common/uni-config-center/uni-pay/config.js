...
module.exports = {
	...
	"notifyUrl": {
		...
		"tcb-bzyinf8h635kbb2-1cbbca13db4b": "https://tcb-bzyinf8h635kbb2-1cbbca13db4b.service.tcloudbase.com/uni-pay-co",
	},
	...
	"wxpay": {
		...
		// 微信 - 小程序支付
		"mp": {
			"appId": "wxb598dce943cae5da", // 小程序的appid
			"secret": "a3e402c5302e37e385ac8200c84a3e65", // 小程序的secret
			"mchId": "1650751076", // 商户id
			"key": "", // v2的api key
			"pfx": fs.readFileSync(__dirname + '/wxpay/apiclient_cert.p12'), // v2需要用到的证书
			"v3Key": "0payWeixinQqCom202308142113APIv3", // v3的api key
